...
export const oauthMetadata = {
	...
	scope:
		'atproto repo:*?action=create&action=update&action=delete rpc:com.atproto.repo.uploadBlob?aud=* rpc:net.at-app.pet.ptr.nucleus.getPreferences?aud=* rpc:net.at-app.pet.ptr.nucleus.putPreferences?aud=* rpc:app.bsky.feed.getFeedSkeleton?aud=* blob:*/*',
